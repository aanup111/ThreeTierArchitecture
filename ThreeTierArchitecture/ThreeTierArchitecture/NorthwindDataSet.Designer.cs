...
namespace ThreeTierArchitecture.NorthwindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Products] SET [ProductName] = @ProductName, [UnitPrice] = @UnitPrice, [Un" +
                "itsInStock] = @UnitsInStock, [Discontinued] = @Discontinued WHERE (([ProductID] " +
                "= @Original_ProductID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ProductID, ProductName, UnitPrice, UnitsInStock, Discontinued\r\nFROM" +
                "            Products\r\nORDER BY ProductID DESC";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Discontinued, ProductID, ProductName, UnitPrice, UnitsInStock FROM Product" +
        ...
        public virtual int FillById(NorthwindDataSet.ProductsDataTable dataTable, int ProductID) {
        ...
        public virtual NorthwindDataSet.ProductsDataTable GetDataById(int ProductID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ProductID));
            NorthwindDataSet.ProductsDataTable dataTable = new NorthwindDataSet.ProductsDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual int Update(string ProductName, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, bool Discontinued, int Original_ProductID) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
